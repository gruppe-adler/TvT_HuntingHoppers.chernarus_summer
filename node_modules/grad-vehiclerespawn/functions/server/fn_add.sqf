/*
	[this, false, 5] call GRAD_vehiclerespawn_fnc_add;
*/
...
private _customCode = [(missionConfigFile >> "GRAD_vehicleRespawn" >> typeOf _vehObj), "customCode", ""] call BIS_fnc_returnConfigEntry;
...
[{
	...
	if (
			...
			[_vehType, _respawnWhenNotDead, _vehDir, _vehPos, _handle, _customCode] call GRAD_vehicleRespawn_fnc_check;
	};
