...
private _positionEmpty = nearestObjects [_vehPos, ["Man", "LandVehicle", "Air"], (sizeOf _vehType)/1.5];
...
if (_isRoom) then {
    ...
    [_vehType, _respawnWhenNotDead, _vehPos, _vehDir, _customCode] call GRAD_vehicleRespawn_fnc_spawn;
};